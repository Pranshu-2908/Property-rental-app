    ...
    <div className="text-center">
      <div className="flex flex-col gap-10 my-10">
        ...
        <h1 className="text-6xl font-bold">
          ...
          <span className="text-purple-800">Dream House</span>
        </h1>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo nam
          quas nisi maxime! Ipsum, consectetur?
        </p>
        <div className="flex w-[40%] shadow-2xl border-2 border-grey-300 pl-3 rounded-full items-center gap-4 mx-auto">
          <input
            type="text"
